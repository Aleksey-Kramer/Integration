...
namespace UzEx.Dapper.Oracle
{
    ...
    public partial class OracleDynamicParameters : SqlMapper.IDynamicParameters
    {
        ...
        {
            if (param is not object obj) return;
            ...
            else if (obj is IEnumerable<KeyValuePair<string, object>> dictionary)
            {
            ...
            else
            {
                ...
                foreach (var prop in props)
                {
                    ...
                    var attr = prop.GetCustomAttribute<OracleAttribute>();
                    
                    if (attr?.SerializeAsJson == true && value != null)
                    {
